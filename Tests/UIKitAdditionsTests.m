// FIXME: These tests need a host application to run and they should be reimplemented
// with a 'functional test' style.
...
//}
//
//// FIXME: This should be a functional test and shouldn't be sending delegate methods that would,
//// normally be called by system. It would be better to integrate a tool that will tell the system that a
//// tap at a cell occured.
